 ...
 */
TopClient.prototype.invoke = function (method, params,reponseNames, callback) {
 ...
 * @public
 */
TopClient.prototype.request = function (params,callback) {
    ...
    var request = RestClient.post(this.url);
